...
const models: TsoaRoute.Models = {
    ...
    "CreateProjectParams": {
        ...
        "properties": {
            ...
            "name": {"dataType":"string","required":true,"validators":{"minLength":{"errorMsg":"The password must be greater than 3","value":3},"maxLength":{"errorMsg":"The password must be less than 20","value":20}}},
            "description": {"dataType":"string","required":true,"validators":{"minLength":{"errorMsg":"The password must be greater than 3","value":3},"maxLength":{"errorMsg":"The password must be less than 20","value":20}}},
            "type": {"dataType":"union","subSchemas":[{"dataType":"enum","enums":["OTHER"]},{"dataType":"enum","enums":["SITE"]},{"dataType":"enum","enums":["BLOG"]},{"dataType":"enum","enums":["ECOMMERCE"]}],"required":true},
    ...
    "UpdateProjectParams": {
        ...
        "properties": {
            ...
            "name": {"dataType":"string","required":true,"validators":{"minLength":{"errorMsg":"The password must be greater than 3","value":3},"maxLength":{"errorMsg":"The password must be less than 20","value":20}}},
            "description": {"dataType":"string","required":true,"validators":{"minLength":{"errorMsg":"The password must be greater than 3","value":3},"maxLength":{"errorMsg":"The password must be less than 20","value":20}}},
            "type": {"dataType":"union","subSchemas":[{"dataType":"enum","enums":["OTHER"]},{"dataType":"enum","enums":["SITE"]},{"dataType":"enum","enums":["BLOG"]},{"dataType":"enum","enums":["ECOMMERCE"]},{"dataType":"enum","enums":[null]}],"required":true},
            "private": {"dataType":"boolean","required":true},
        },
        "additionalProperties": false,
    },
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/auth/me',
            ...
            function loginController_me(request: any, response: any, next: any) {
            const args = {
